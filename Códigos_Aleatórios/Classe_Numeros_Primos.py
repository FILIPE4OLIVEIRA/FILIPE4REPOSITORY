...
class Numeros_Primos:
    ...
    def __init__(self, Numb = 2, list_prime = [2]):
        self.numb = Numb
    ...
    def Teste_Primos(self):
        ...
        if(self.numb in self.list):
            P3 = print(" O Número %.i é um Número Primo!" % self.numb)
            return(P3)
        else:
            P4 = print(" O Número %.i não é um Número Primo!" % self.numb)
        return(P4)

while(True):
    if(__name__ == '__main__'):
        Numero = Numeros_Primos(int(input("Digite um Número Limite: ")))
        Numero.Teste_Primos()
        Numero.Lista_Primos()